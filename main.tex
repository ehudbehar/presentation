...
\begin{figure}
  \includegraphics[width=0.7\textwidth,height=175pt]{figures/results/oscillator/oscillator_waveform.tikz}
\end{figure}
 \end{frame}
...
\begin{figure}
      \includegraphics[width=\textwidth,height=157pt]{figures/results/oscillator/guiding01.tikz}
\end{figure}
 \end{frame}
\begin{frame}{Optical Guiding}
...
\tikzsetnextfilename{guiding03}
\begin{figure}
 \includegraphics[width=\textwidth,height=120pt]{figures/results/oscillator/guiding03.tikz}
\end{figure}
\end{frame}
