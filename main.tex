...
\end{frame}
 ...
 \begin{frame}{Dephasing length}
   ...
   \begin{columns}
     \column{0.5\textwidth}
     \includegraphics[width=\textwidth]{figures/theory/coupling_scheme.pdf}
     \column{0.5\textwidth}
 ...
 \begin{frame}{Characteristic quantities}
   \begin{tabular}{l c r}
   \onslide<1-> Debye length & $\lambda_D=\sqrt{\frac{\varepsilon_0 k_B T_e}{N_e e^2}}$ &  \includegraphics[height=50pt]{figures/theory/white_background.png}\\ 
   \onslide<2-> Plasma Frequency & $ \omega_p=\sqrt{\frac{N_e e^2}{m_e \varepsilon_0}}\si[per-mode=fraction]{\radian\per\sec} $ & \includegraphics[height=50pt]{figures/theory/white_background.png}\\
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=120pt]{figures/theory/lineshape.tikz}
\column{0.5\textwidth}
...
\end{center}
\begin{figure}
   \includegraphics[width=270pt,height=144pt]{figures/results/spectro/parabolic_profile.tikz}
\end{figure}
\end{frame}
