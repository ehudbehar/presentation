...
\usepackage{tikz,graphicx,siunitx}
...
\begin{figure}
    \centering
    %\includestandalone[width=0.4\textwidth]{figures/radiativeTransfer}
...
\begin{frame}{Radiation Transition}
  ...
  \end{column}
  \begin{column}{0.4\textwidth}
\includestandalone[width=1.2\textwidth]{figures/radiationTransition}
  \end{column}
  \end{columns}
\end{frame}
\begin{frame}
...
\begin{figure}{Line Broadening}
  \includestandalone[width=0.7\textwidth,height=0.3\textwidth]{figures/lineshape}
\end{figure}
...
\begin{frame}{Stark effect}
  ...
  \begin{frame}{Stark effect}
    ...
    \begin{figure}
    \includestandalone[width=0.5\textwidth]{figures/starkBroadening}
    \end{figure}
  \end{frame}
  \begin{frame}{Stark effect}
...
\end{frame}
  ...
  \begin{frame}{Methods for creating a plasma channel}
    ...
    \end{description}
    \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{figures/ablated.png} & \includegraphics[width=0.5\textwidth]{figures/gasfilled.png}
    \end{tabular}
  ...
  \begin{frame}{Why the channel forms}{Explanation, continued}
     ...
     \begin{figure}
       \includegraphics[width=0.4\textwidth]{figures/why channel forms.png}
     \end{figure}
